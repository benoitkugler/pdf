// Compact Font Format parser, adapted from golang.org/x/image/font/sfnt
package type1C
...
func (p *cffParser) parse() (CFF, error) {
	...
	// 		return CFF{}, errUnsupportedNumberOfFontDicts
	// 	}
	...
	// 	}
	// }
	return CFF{Encoding: encoding}, nil
}
...
func (p *cffParser) parseUserStrings() (userStrings, error) {
	...
	userStrings := make(userStrings, count)
	if count != 0 {
