...
func TestMetrics(t *testing.T) {
	cmapFont, err := ioutil.ReadFile(filepath.FromSlash("../../../../../golang.org/x/image/font/testdata/cmapTest.ttf"))
	if err != nil {
		t.Fatal(err)
	}
...
func testSegments(t *testing.T, filename string, wants [][]Segment) {
	data, err := ioutil.ReadFile(filepath.FromSlash("../../../../../golang.org/x/image/font/testdata/" + filename))
	if err != nil {
...
func TestPPEM(t *testing.T) {
	data, err := ioutil.ReadFile(filepath.FromSlash("../../../../../golang.org/x/image/font/testdata/glyfTest.ttf"))
	if err != nil {
		t.Fatalf("ReadFile: %v", err)
	}
	f, err := Parse(data)
