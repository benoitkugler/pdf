...
func TestParseArray(t *testing.T) {
	...
	doTestParseObjectFail("[   <>", t)
	doTestParseObjectFail("[   <    >", t)
	doTestParseObjectFail("[<ABG>", t)
	doTestParseObjectFail("[<FEFF ABC2>", t) // white space shall be ignored
	doTestParseObjectFail("[<   ABG>", t)
	doTestParseObjectFail("[<AB>", t)
	doTestParseObjectFail("[<ABc>    ", t)
	doTestParseObjectFail("[<0ab> <bcf098>", t)
	doTestParseObjectFail("[a]", t)
	doTestParseObjectFail("[<0ab> <bcf098>a]", t)
	doTestParseObjectFail("[<0ab> <bcf098> a]", t)
